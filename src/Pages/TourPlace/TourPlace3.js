    ...
    return (
        <div>
         ...
         <div className='row row-cols-md-2 row cols-1   container-fluid pt-5  pb-5'>
             ...
             <div className=' pt-2 '>
                 <img className=' img-fluid' src="https://images.pexels.com/photos/592941/pexels-photo-592941.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="" />
             </div>
         </div>
         {/* sjdhfkjsh */}
