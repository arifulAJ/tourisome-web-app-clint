...
const TourPlace1 = () => {
    return (
        <div>
         ...
         <div className='row row-cols-md-2 row cols-1   container-fluid pt-5 '>
             ...
             <div className=' pt-2 '>
                 <img className=' img-fluid' src="https://sktthemesdemo.net/trip/wp-content/uploads/2020/10/adventure-tours.jpg" alt="" />
             </div>
         </div>
         {/* sjdhfkjsh */}
